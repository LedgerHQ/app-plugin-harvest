...
You can see that this [CI](https://github.com/LedgerHQ/app-plugin-harvest/blob/develop/.github/workflows/check_sdk.yml) workflow
...
The documentation about the plugin shall be added in [PLUGIN_SPECIFICATON.md](https://github.com/LedgerHQ/app-plugin-harvest/blob/develop/PLUGIN_SPECIFICATION.md). It shall includes at least the smart contracts and functions supported by the plugin.

## Formatting

The C source code is expected to be formatted with `clang-format` 11.0.0 or higher.

## Manual Test to check Logs
```
pytest ./tests/ --tb=short -v --device nanos -s
```
