...
with open("%s/0xf0358e8c3cd5fa238a29301d0bea3d63a17bedbe.abi.json" % (ABIS_FOLDER)) as file:
...
def test_vault_deposit(backend, firmware, navigator, test_name, wallet_addr):
    client = EthAppClient(backend)
    data = contract.encodeABI("deposit", [AMOUNT])
    ...
    tx_params = {
        ...
        "maxPriorityFeePerGas": Web3.to_wei(23, "gwei"),
        "gas": 330970,
        "to": contract.address,
